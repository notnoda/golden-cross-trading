...
class Strategy_20250423_01(BaseStrategy):
    ...
    def execute(self):
        ...
        self.ready(self.__storages[0], self.__TICK_BUY[0][2])
        self.ready(self.__storages[1], self.__TICK_BUY[1][2])
    ...
    def __is_buy(self, storage, tick_size):
        tails = analysis.add_ichimoku(storage.get_df(tick_size)).tail(20)
